...
public class DrawList {
     ...
     *
     * @return La fecha del primer sorteo registrado
     */
    public TDateInteger getFirstDrawDate() {
     ...
     *
     * @return La fecha del último sorteo registrado
     */
    public TDateInteger getLastDrawDate() {
        return lastDrawDate;
    }
