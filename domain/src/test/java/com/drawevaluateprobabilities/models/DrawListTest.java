...
class DrawListTest {
    ...
    void testGetPreviousDate() {
        ...
        assertEquals(date1, drawList.getPreviousDate(date2));
        assertEquals(date2, drawList.getPreviousDate(date3));
    }
    ...
    void testGetNextDate() {
        ...
        assertEquals(date2, drawList.getNextDate(date1));
        assertEquals(date3, drawList.getNextDate(date2));
    ...
    void testAddNextDraw() {
        ...
        assertEquals(date4.toInteger(), drawList.getLastDrawDate().toInteger());
    ...
    void testGetFirstDrawDate() {
        TDateInteger date1 = new TDateInteger("2023-01-01", "yyyy-mm-dd");
        assertEquals(date1, drawList.getFirstDrawDate());
    }

    @Test
    void testGetLastDrawDate() {
        TDateInteger date3 = new TDateInteger("2023-01-03", "yyyy-mm-dd");
        assertEquals(date3, drawList.getLastDrawDate());
    }
}